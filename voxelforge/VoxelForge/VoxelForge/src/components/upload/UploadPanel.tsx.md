        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', marginTop: '4px' }}>
              ...
              >
                �Y�� Load Mock Floorplan (Procedural)
              </button>
              <button
                className="btn btn-small"
              ...
              >
                �Y"� Load Building Asset (Real GLB)
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', marginTop: '4px' }}>
              ...
              >
                �sT️ Load Mock Gearbox (Procedural)
              </button>
              <button
                className="btn btn-small"
                style={{ justifyContent: 'flex-start', fontFamily: 'var(--font-mono)', color: 'var(--accent-cyan)', borderColor: 'var(--accent-cyan)' }}
